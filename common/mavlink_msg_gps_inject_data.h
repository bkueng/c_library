...
typedef struct __mavlink_gps_inject_data_t
{
 ...
 uint8_t data[250]; /*< raw data (110 is enough for 12 satellites of RTCMv2)*/
} mavlink_gps_inject_data_t;

#define MAVLINK_MSG_ID_GPS_INJECT_DATA_LEN 253
#define MAVLINK_MSG_ID_123_LEN 253

#define MAVLINK_MSG_ID_GPS_INJECT_DATA_CRC 133
#define MAVLINK_MSG_ID_123_CRC 133

#define MAVLINK_MSG_GPS_INJECT_DATA_FIELD_DATA_LEN 250
...
#define MAVLINK_MESSAGE_INFO_GPS_INJECT_DATA { \
	...
	{  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_gps_inject_data_t, target_system) }, \
         ...
         { "data", NULL, MAVLINK_TYPE_UINT8_T, 250, 3, offsetof(mavlink_gps_inject_data_t, data) }, \
         } \
}
